...
import { markoJson, markoJsonPath } from "app/util/workspace/fs";
...
export function start(scope: Scope, { assets }: StartOptions): void {
  ...
  // finder discovers sibling `.marko` files as custom tags here too.
  vfs.writeFile(markoJsonPath, markoJson);
