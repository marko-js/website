...
declare module "@marko/run" {
	interface AppData extends Run.DefineApp<{
		routes: {
			...
			"/docs/explanation/why-is-marko-fast": { verb: "get"; meta: typeof import("../src/routes/docs/_compiled-docs/explanation/why-is-marko-fast+meta.json"); };
			...
			"/docs/introduction/integrations": { verb: "get"; meta: typeof import("../src/routes/docs/_compiled-docs/introduction/integrations+meta.json"); };
			...
			"/docs/reference/lazy-loading": { verb: "get"; meta: typeof import("../src/routes/docs/_compiled-docs/reference/lazy-loading+meta.json"); };
			...
			"/docs/reference/supported-environments": { verb: "get"; meta: typeof import("../src/routes/docs/_compiled-docs/reference/supported-environments+meta.json"); };
			...
			"/docs/tutorial/fetching-data": { verb: "get"; meta: typeof import("../src/routes/docs/_compiled-docs/tutorial/fetching-data+meta.json"); };
			"/docs/tutorial/fundamentals": { verb: "get"; meta: typeof import("../src/routes/docs/_compiled-docs/tutorial/fundamentals+meta.json"); };
			"/docs/tutorial/timers-and-effects": { verb: "get"; meta: typeof import("../src/routes/docs/_compiled-docs/tutorial/timers-and-effects+meta.json"); };
			"/docs/tutorial/working-with-lists": { verb: "get"; meta: typeof import("../src/routes/docs/_compiled-docs/tutorial/working-with-lists+meta.json"); };
...
declare module "../src/routes/docs/_compiled-docs/explanation/why-is-marko-fast+page.marko" {
  namespace MarkoRun {
    export { NotHandled, NotMatched, GetPaths, PostPaths, GetablePath, GetableHref, PostablePath, PostableHref, Platform };
    export type Route = Run.Routes["/docs/explanation/why-is-marko-fast"];
    export type Context = Run.MultiRouteContext<Route> & Marko.Global;
    export type Handler = Run.HandlerLike<Route>;
    export type GET = Run.HandlerLike<Route, "GET">;
    export type HEAD = Run.HandlerLike<Route, "HEAD">;
...
declare module "../src/routes/docs/_compiled-docs/introduction/integrations+page.marko" {
  namespace MarkoRun {
    export { NotHandled, NotMatched, GetPaths, PostPaths, GetablePath, GetableHref, PostablePath, PostableHref, Platform };
    export type Route = Run.Routes["/docs/introduction/integrations"];
    export type Context = Run.MultiRouteContext<Route> & Marko.Global;
    export type Handler = Run.HandlerLike<Route>;
    export type GET = Run.HandlerLike<Route, "GET">;
    export type HEAD = Run.HandlerLike<Route, "HEAD">;
...
declare module "../src/routes/docs/_compiled-docs/reference/lazy-loading+page.marko" {
  namespace MarkoRun {
    export { NotHandled, NotMatched, GetPaths, PostPaths, GetablePath, GetableHref, PostablePath, PostableHref, Platform };
    export type Route = Run.Routes["/docs/reference/lazy-loading"];
    export type Context = Run.MultiRouteContext<Route> & Marko.Global;
    export type Handler = Run.HandlerLike<Route>;
    export type GET = Run.HandlerLike<Route, "GET">;
    export type HEAD = Run.HandlerLike<Route, "HEAD">;
...
declare module "../src/routes/docs/_compiled-docs/reference/supported-environments+page.marko" {
  namespace MarkoRun {
    export { NotHandled, NotMatched, GetPaths, PostPaths, GetablePath, GetableHref, PostablePath, PostableHref, Platform };
    export type Route = Run.Routes["/docs/reference/supported-environments"];
    export type Context = Run.MultiRouteContext<Route> & Marko.Global;
    export type Handler = Run.HandlerLike<Route>;
    export type GET = Run.HandlerLike<Route, "GET">;
    export type HEAD = Run.HandlerLike<Route, "HEAD">;
...
declare module "../src/routes/docs/_compiled-docs/tutorial/fetching-data+page.marko" {
  namespace MarkoRun {
    export { NotHandled, NotMatched, GetPaths, PostPaths, GetablePath, GetableHref, PostablePath, PostableHref, Platform };
    export type Route = Run.Routes["/docs/tutorial/fetching-data"];
    export type Context = Run.MultiRouteContext<Route> & Marko.Global;
    export type Handler = Run.HandlerLike<Route>;
    export type GET = Run.HandlerLike<Route, "GET">;
    export type HEAD = Run.HandlerLike<Route, "HEAD">;
...
declare module "../src/routes/docs/_compiled-docs/tutorial/timers-and-effects+page.marko" {
  namespace MarkoRun {
    export { NotHandled, NotMatched, GetPaths, PostPaths, GetablePath, GetableHref, PostablePath, PostableHref, Platform };
    export type Route = Run.Routes["/docs/tutorial/timers-and-effects"];
    export type Context = Run.MultiRouteContext<Route> & Marko.Global;
    export type Handler = Run.HandlerLike<Route>;
    export type GET = Run.HandlerLike<Route, "GET">;
    export type HEAD = Run.HandlerLike<Route, "HEAD">;
...
declare module "../src/routes/docs/_compiled-docs/tutorial/working-with-lists+page.marko" {
  namespace MarkoRun {
    export { NotHandled, NotMatched, GetPaths, PostPaths, GetablePath, GetableHref, PostablePath, PostableHref, Platform };
    export type Route = Run.Routes["/docs/tutorial/working-with-lists"];
    export type Context = Run.MultiRouteContext<Route> & Marko.Global;
    export type Handler = Run.HandlerLike<Route>;
    export type GET = Run.HandlerLike<Route, "GET">;
    export type HEAD = Run.HandlerLike<Route, "HEAD">;
